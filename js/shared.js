     $(document).ready(function() {
       ...
       $(".reach").attr("title", "This weapon adds 5 feet to your reach when you attack with it, as well as when determining your reach for opportunity attacks with it.");
       $(".heavy").attr("title", "Small creatures have disadvantage on attack rolls with heavy weapons. A heavy weapon's size and bulk make it too large or a Small creature to use effectively.");
